...
class SeqUnitBi(object):
    ...
    def build_encoder(self):
        ...
        with tf.variable_scope('encoder'):
            ...
            with tf.device('/gpu:0'):
                outputs, states = tf.nn.bidirectional_dynamic_rnn(cell_fw=self.f_encoder_cell,
                                                                                 cell_bw=self.b_encoder_cell,
                ...
                self.encoder_outputs = tf.concat([output_fw, output_bw], axis=2)
                ...
                #print("selfencoder_last_state", self.encoder_last_state)
